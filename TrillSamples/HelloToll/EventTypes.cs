...
namespace HelloToll
{
  ...
  internal sealed class TollCompare
  {
    ...
    public string TollId3 { get; set; }
    public ulong VehicleCount1 { get; set; }
    public ulong VehicleCount2 { get; internal set; }
    public ulong VehicleCount3 { get; internal set; }

    public override string ToString()
    {
      return new { this.TollId1, this.TollId2, this.TollId3, this.VehicleCount1, this.VehicleCount2, this.VehicleCount3 }.ToString();
    }
  }
